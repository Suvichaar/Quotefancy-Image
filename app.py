...
# ===================== 🧹 TAB 4: Distribute ALT Image-Text Pairs to Author Rows =====================
...
# ===================== 🧹 TAB 5: Generate Resized Image CDN URLs =====================
with tab5:
...
# ===================== 🧹 TAB 7:Add Suvichaar Metadata + UUID + Canonical URLs =====================
...
# ===================== 🧹 TAB 9: Add Random Video Rows + Circular Navigation (Final) =====================
...
# ===================== 🧹 TAB 10: Final Column Order Template Reorder =====================
